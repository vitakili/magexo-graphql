import {
  ApolloError,
  isApolloError
} from "./chunk-3NVRS4PA.js";
import "./chunk-BHW43T3C.js";
import {
  computed,
  getCurrentInstance,
  inject,
...
function useQueryImpl(document, variables, options = {}, lazy = false) {
  ...
  function start() {
    ...
    }, currentOptions.value), isServer && ((_c = currentOptions.value) == null ? void 0 : _c.fetchPolicy) !== "no-cache" ? {
...
function useMutation(document, options = {}) {
  ...
  async function mutate(variables, overrideOptions = {}) {
    ...
    called.value = true;
    try {
      const result = await client.mutate(__spreadProps(__spreadValues(__spreadValues({
        mutation: currentDocument
      }, currentOptions), overrideOptions), {
        variables: (variables != null ? variables : currentOptions.variables) ? __spreadValues(__spreadValues({}, currentOptions.variables), variables) : void 0
      }));
      loading.value = false;
...
function useSubscription(document, variables = void 0, options = {}) {
  ...
  function start() {
    ...
    subscription.value = client.subscribe(__spreadValues({
      query: currentDocument,
      variables: currentVariables
